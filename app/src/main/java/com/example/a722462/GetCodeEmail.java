...
public class GetCodeEmail extends AppCompatActivity {
            ...
            if(s.length() > 0) {
                switch(selectedPosition) {
                    ...
                    case 3:
                        ...
                        if(isCurrentCode) {
                            Toast.makeText(GetCodeEmail.this, "Все верно", Toast.LENGTH_SHORT).show();
                            Intent create_password = new Intent(GetCodeEmail.this, CreatePassword.class);
                            startActivity(create_password);
                        } else {
                            Toast.makeText(GetCodeEmail.this, "Неверно введен код", Toast.LENGTH_SHORT).show();
                            goEmail();
    ...
    private boolean checkCode() {
        ...
        call.enqueue(new Callback<Email>() {
            ...
            public void onFailure(@NonNull Call<Email> call, @NonNull Throwable t) {
                Toast.makeText(GetCodeEmail.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
